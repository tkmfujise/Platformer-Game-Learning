...
....
control "Root" as R
participant "$Path3D\n/PathFollow3D" as T0 #FFC0CB
participant "$Path3D\n/PathFollow3D\n/Camera3D" as T1 #FFC0CB
...
....
control "Root" as R
participant "$Path3D\n/PathFollow3D\n/Camera3D" as T0 #FFC0CB
participant "$Path3D\n/PathFollow3D" as T2 #FFC0CB
...
|===
|Name |Value
|*transform* a|`Transform3D(7.548501e-08, 0.0009998279, 0.9998273, -5.8197773e-11, 0.999828, -0.0009998273, -0.99983, 1.7287196e-11, 7.548486e-08, -3.774892e-10, 2.9103833e-13, 2.005)`
|*h_offset* a|`-0.005`
|===
[.node-property.node-3d]
...
|*transform* a|`Transform3D(-0.5192033, 0.07535022, -0.8515238, 0.00043800563, 0.996302, 0.08789438, 0.8548498, 0.045254376, -0.51722825, 0.52904, 0.621466, -0.783036)`
|*fov* a|`40.0`
|*near* a|`0.057`
|===
...
|Name |Value
|*unique_name_in_owner* a|`true`
|*libraries/* a|`SubResource("AnimationLibrary_as40k")`
|*autoplay* a|`&"opening"`
|===
...
func force_zoom_chapter(idx: int) -> void:
