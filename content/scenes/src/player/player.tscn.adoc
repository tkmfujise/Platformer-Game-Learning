...
func compute_state(delta: float, direction: Vector2) -> State:
	...
	and direction:
		...
		var on_wall = true # TODO
		if on_wall and is_just_input_action(&'move_climb'):
			return State.CLIMBING
		elif not is_on_floor():
			falling_time += delta
		else:
			if not state == State.GROUNDING: landed.emit()
			falling_time = 0
...
func is_just_input_action(key: StringName) -> bool:
	return playable and Input.is_action_just_pressed(key)
