...
class N15 as "FrontRayCast" <<(R,lightskyblue) RayCast2D>> {
}
class N16 as "RestartCurtain" <<(C,lightgreen) Control>> {
  ~ animation_finished
---
  * pattern
  * center
...
class N17 as "Camera" <<(C,lightskyblue) Camera2D>> {
  - DASH_SHAKING_TIME
  * shaking_time
  * fixed_position
  * current_frames
...
class N18 as "AnimationPlayer" <<(A,yellow) AnimationPlayer>> {
}
class N19 as "AnimationTree" <<(A,yellow) AnimationTree>> {
}
R --o N1
R --o N10
R --o N11
