...
[plantuml]
....
class R as "Player" <<(C,#87CEFA) CharacterBody2D>> {
  ~ dashed
  ~ failed
---
  - SPEED
...
class N1 as "Sprites" <<(N,#87CEFA) Node2D>> {
}
class N2 as "SpriteStates" <<(N,#87CEFA) Node2D>> {
}
class N3 as "IdleSprite2D" <<(S,#87CEFA) Sprite2D>> {
}
class N4 as "RunSprite2D" <<(S,#87CEFA) Sprite2D>> {
}
class N5 as "JumpSprite2D" <<(S,#87CEFA) Sprite2D>> {
}
class N6 as "FallSprite2D" <<(S,#87CEFA) Sprite2D>> {
}
class N7 as "SpriteEffects" <<(N,#87CEFA) Node2D>> {
}
class N8 as "BurstSprite2D" <<(S,#87CEFA) Sprite2D>> {
}
class N9 as "CollisionShape2D" <<(C,#87CEFA) CollisionShape2D>> {
}
class N10 as "FailureCollision" <<(A,#87CEFA) Area2D>> {
}
class N11 as "CollisionShape2D" <<(C,#87CEFA) CollisionShape2D>> {
}
class N12 as "FrameSubject" <<(A,#87CEFA) Area2D>> {
}
class N13 as "CollisionShape2D" <<(C,#87CEFA) CollisionShape2D>> {
}
class N14 as "Camera" <<(C,#87CEFA) Camera2D>> {
  - DASH_SHAKING_TIME
  * shaking_time
  * fixed_position
  * current_frames
...
class N15 as "AnimationPlayer" <<(A,#FFFF00) AnimationPlayer>> {
}
class N16 as "AnimationTree" <<(A,#FFFF00) AnimationTree>> {
}
R --o N1
R --o N9
R --o N10
...
|*parameters/Fall/blend_position* a|`0.195104`
|*parameters/Idle/blend_position* a|`-0.27003`
|*parameters/Jump/blend_position* a|`0.414688`
|*parameters/Run/blend_position* a|`-0.997033`
|===
