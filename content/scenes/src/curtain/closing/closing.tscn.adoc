...
[plantuml]
....
class ROOT as "ClosingCurtain" <<(C,lightgreen) Control>> {
  * pattern
  * next_scene
---
  + play()
...
class Pattern1 as "Pattern1" <<(N,lightskyblue) Node2D>> {
}
class Pattern1_LeftCurtain as "LeftCurtain" <<(P,lightskyblue) Polygon2D>> {
}
class Pattern1_RightCurtain as "RightCurtain" <<(P,lightskyblue) Polygon2D>> {
}
class Pattern2 as "Pattern2" <<(C,lightgreen) ColorRect>> {
}
class Pattern3 as "Pattern3" <<(C,lightgreen) ColorRect>> {
}
...
Pattern1 --o Pattern1_LeftCurtain
Pattern1 --o Pattern1_RightCurtain
...
"update": 0,
"values": [PackedVector2Array(1920, 1080, 1920, 0, 1920, 0, 1920, 540, 1920, 1080), PackedVector2Array(1920, 1080, 1920, 0, 960, 0, 1920, 540, 960, 1080), PackedVector2Array(1920, 1080, 1920, 0, 960, 0, 960, 540, 960, 1080)]
}`
|_sub_resource_ |*tracks/1/type* |`value`
|_sub_resource_ |*tracks/1/imported* |`false`
|_sub_resource_ |*tracks/1/enabled* |`true`
...
"transitions": PackedFloat32Array(1, 0.25, 1),
"update": 0,
"values": [PackedVector2Array(0, 0, 0, 1080, 0, 1080, 0, 548, 0, 0), PackedVector2Array(0, 0, 0, 1080, 960, 1080, 0, 548, 960, 0), PackedVector2Array(0, 0, 0, 1080, 960, 1080, 960, 548, 960, 0)]
}`
|_sub_resource_ |*tracks/2/type* |`value`
|_sub_resource_ |*tracks/2/imported* |`false`
|_sub_resource_ |*tracks/2/enabled* |`true`
...
|_node_ |*script* |`ExtResource("1_56cl0")`
