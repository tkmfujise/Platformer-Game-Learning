...
[plantuml]
....
class ROOT as "ClosingCurtain" <<Control>> {
  * pattern
  * next_scene
---
  + play()
...
class Pattern1 as "Pattern1" <<Node2D>> {
}
class Pattern1_LeftCurtain as "LeftCurtain" <<Polygon2D>> {
}
class Pattern1_RightCurtain as "RightCurtain" <<Polygon2D>> {
}
class Pattern2 as "Pattern2" <<ColorRect>> {
}
class Pattern3 as "Pattern3" <<ColorRect>> {
}
