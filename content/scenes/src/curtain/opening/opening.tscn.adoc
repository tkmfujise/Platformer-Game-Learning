...
class N6 as "Pattern4" <<(C,lightgreen) ColorRect>> {
}
...
** [.node-name.type-control]#Pattern4# [.node-type.type-control]#ColorRect#
...
participant "$Pattern4" as T7 #90EE90
...
participant "$Pattern4" as T5 #90EE90
...
participant "$Pattern4" as T4 #90EE90
...
|*grow_horizontal* a|`2`
|*grow_vertical* a|`2`
|*script* a|link:/scripts/src/curtain/opening/opening.gd[res://src/curtain/opening/opening.gd]
|===
...
|Name |Value
|*visible* a|`false`
|*material* a|`SubResource("ShaderMaterial_2igm1")`
|*layout_mode* a|`1`
|*anchors_preset* a|`15`
|*anchor_right* a|`1.0`
|*anchor_bottom* a|`1.0`
