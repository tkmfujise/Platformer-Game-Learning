---
title: src/stages/0/gimmicks/springboard/springboard.tscn
---
:toc:

== src / stages / 0 / gimmicks / springboard / springboard.tscn
...
|*hframes* a|`19`
|*script* a|link:/scripts/src/stages/0/gimmicks/springboard/springboard.gd[res://src/stages/0/gimmicks/springboard/springboard.gd]
|===
[.node-property.node-2d]
.#$Area2D# properties
[cols="1,3" options="header"]
...
=== link:/scripts/src/stages/0/gimmicks/springboard/springboard.gd[springboard.gd]
