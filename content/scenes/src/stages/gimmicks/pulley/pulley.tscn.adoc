...
class N3 as "Wire" <<(N,lightgreen) NinePatchRect>> {
}
...
=== Assets
[.asset-image]
[link=/assets/assets/images/stages/gimmicks/Pulley/Pulley.png]
image::/assets/raw/assets/images/stages/gimmicks/Pulley/Pulley.png[200, 100] 
...
*** [.node-name.type-control]#Wire# [.node-type.type-control]#NinePatchRect#
...
func _on_area_2d_area_entered(area: Area2D) -> void:
	...
	if state == State.IDLE: move.call_deferred()
```
[.signal-connection]
...
|Name |Value
|*unique_name_in_owner* a|`true`
|*offset_left* a|`-6.142857`
|*offset_top* a|`-6.2857146`
|*offset_right* a|`37.85714`
|*offset_bottom* a|`5.7142854`
|*pivot_offset* a|`Vector2(6, 6)`
|*texture* a|[link=/assets/assets/images/stages/gimmicks/Pulley/Pulley.png]
[.asset-image]
.res://assets/images/stages/gimmicks/Pulley/Pulley.png
image::/assets/raw/assets/images/stages/gimmicks/Pulley/Pulley.png[]

|*region_rect* a|`Rect2(17, 0, 83, 12)`
|*patch_margin_left* a|`11`
|*patch_margin_right* a|`11`
|*axis_stretch_horizontal* a|`1`
|===
[.node-property.node-2d]
...
|===
|Name |Value
|*position* a|`Vector2(-0.7142836, -0.35714257)`
...
func redraw_wire_length() -> void:
	%Wire.size.x = (distance + MIN_DISTANCE) / %Sprites.scale.x
