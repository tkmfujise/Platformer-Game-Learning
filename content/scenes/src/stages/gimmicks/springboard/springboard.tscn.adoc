---
title: src/stages/gimmicks/springboard/springboard.tscn
---
:toc:
...
[plantuml]
....
class R as "Springboard" <<(S,lightskyblue) Sprite2D>> {
  - FORCE
  * standby
---
  + hit()
...
=== Scene Tree
[.scene-tree]
* [.node-name.type-2d]#Springboard# [.node-type.type-2d]#Sprite2D#
...
|*hframes* a|`19`
|*script* a|link:/scripts/src/stages/gimmicks/springboard/springboard.gd[res://src/stages/gimmicks/springboard/springboard.gd]
|===
[.node-property.node-2d]
.#$Area2D# properties
[cols="1,3" options="header"]
...
|*libraries/* a|`SubResource("AnimationLibrary_vsbdv")`
|===


=== link:/scripts/src/stages/gimmicks/springboard/springboard.gd[springboard.gd]
