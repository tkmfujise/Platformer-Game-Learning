...
.$.:[#_selected_#]=>$.
```gdscript
func _on_selected(idx: int, force: bool = false) -> void:
	%Menu.grab_focus_first = true
	selected_chapter_idx = idx
	zoom_pin_to(idx)
	get_chapter(idx).selected()
	set_chapters_animation_offset()
	if not force: %ChaptersAnimationPlayer.play("selected")
...
func _on_menu_ui_backed() -> void:
	if current_plate == Plate.MENU:
		...
		force_focus_return()
		# FIXME なんでか %ChaptersContainer のポジションが動かないので強制的に上書きする
		await %ChaptersAnimationPlayer.animation_finished
		%AnimationPlayer.stop(true)
		%ChaptersContainer.position.y = 8
```
[.signal-connection]
...
|*offset_left* a|`-100.48004`
|*offset_top* a|`-220.0`
|*offset_right* a|`99.51996`
|*offset_bottom* a|`-20.0`
|===
[.node-property.node-control]
...
|*resource* a|link:/resources/data/chapters/chapter_0.tres[res://data/chapters/chapter_0.tres]
|===
[.node-property.node-control]
...
|*resource* a|link:/resources/data/chapters/chapter_1.tres[res://data/chapters/chapter_1.tres]
|===
...
|*resource* a|link:/resources/data/chapters/chapter_2.tres[res://data/chapters/chapter_2.tres]
|===
[.node-property.node-plain]
...
|*resource* a|link:/resources/data/chapters/chapter_3.tres[res://data/chapters/chapter_3.tres]
|===
[.node-property.node-plain]
...
|*resource* a|link:/resources/data/chapters/chapter_4.tres[res://data/chapters/chapter_4.tres]
|===
[.node-property.node-plain]
...
|*resource* a|link:/resources/data/chapters/chapter_5.tres[res://data/chapters/chapter_5.tres]
|===
[.node-property.node-plain]
...
|*resource* a|link:/resources/data/chapters/chapter_6.tres[res://data/chapters/chapter_6.tres]
|===
[.node-property.node-plain]
...
|*resource* a|link:/resources/data/chapters/chapter_7.tres[res://data/chapters/chapter_7.tres]
|===
[.node-property.node-plain]
...
|*resource* a|link:/resources/data/chapters/chapter_8.tres[res://data/chapters/chapter_8.tres]
|===
[.node-property.node-plain]
...
|*libraries/* a|`SubResource("AnimationLibrary_c4ypt")`
|===
[.node-property.node-other]
...
|Name |Value
|*unique_name_in_owner* a|`true`
|*libraries/* a|`SubResource("AnimationLibrary_wkduh")`
|===
