...
[plantuml]
....
class R as "Chapters" <<(C,#90EE90) Control>> {
  ~ focused
  ~ selected
  ~ ui_backed
---
...
class N1 as "Banner" <<(T,#90EE90) TextureRect>> {
}
class N2 as "ChaptersContainer" <<(H,#90EE90) HBoxContainer>> {
}
class N3 as "Chapter_0" <<(M,#90EE90) MarginContainer>> {
  * play_opening
  * resource
...
class N4 as "Chapter_1" <<(M,#90EE90) MarginContainer>> {
  * play_opening
  * resource
  * focus_animation_skip
---
...
class N5 as "Sprite2D" <<(N,#A9A9A9) Node>> {
}
class N6 as "Chapter_2" <<(M,#90EE90) MarginContainer>> {
  * play_opening
  * resource
  * focus_animation_skip
---
...
class N7 as "Sprite2D" <<(N,#A9A9A9) Node>> {
}
class N8 as "Chapter_3" <<(M,#90EE90) MarginContainer>> {
  * play_opening
  * resource
  * focus_animation_skip
---
...
class N9 as "Sprite2D" <<(N,#A9A9A9) Node>> {
}
class N10 as "Chapter_4" <<(M,#90EE90) MarginContainer>> {
  * play_opening
  * resource
  * focus_animation_skip
---
...
class N11 as "Sprite2D" <<(N,#A9A9A9) Node>> {
}
class N12 as "Chapter_5" <<(M,#90EE90) MarginContainer>> {
  * play_opening
  * resource
  * focus_animation_skip
---
...
class N13 as "Sprite2D" <<(N,#A9A9A9) Node>> {
}
class N14 as "Chapter_6" <<(M,#90EE90) MarginContainer>> {
  * play_opening
  * resource
  * focus_animation_skip
---
...
class N15 as "Sprite2D" <<(N,#A9A9A9) Node>> {
}
class N16 as "Chapter_7" <<(M,#90EE90) MarginContainer>> {
  * play_opening
  * resource
  * focus_animation_skip
---
...
class N17 as "Sprite2D" <<(N,#A9A9A9) Node>> {
}
class N18 as "Chapter_8" <<(M,#90EE90) MarginContainer>> {
  * play_opening
  * resource
  * focus_animation_skip
---
...
class N19 as "Sprite2D" <<(N,#A9A9A9) Node>> {
}
class N20 as "Grid1920x1080" <<(S,#87CEFA) Sprite2D>> {
}
class N21 as "Pin" <<(N,#87CEFA) Node2D>> {
}
class N22 as "Menu" <<(C,#90EE90) Control>> {
  ~ ui_backed
  ~ get_started
---
  * grab_focus_first
...
class N23 as "ChaptersAnimationPlayer" <<(A,#FFFF00) AnimationPlayer>> {
}
class N24 as "AnimationPlayer" <<(A,#FFFF00) AnimationPlayer>> {
}
R --o N1
R --o N2
R --o N20
...
....
control "Root" as R
participant "$Banner" as T0 #90EE90
participant "$ChaptersContainer" as T1 #90EE90
participant "$ChaptersContainer\n/Chapter_0" as T2 #90EE90
participant "$ChaptersContainer\n/Chapter_1" as T3 #90EE90
participant "$ChaptersContainer\n/Chapter_2" as T4 #90EE90
participant "$ChaptersContainer\n/Chapter_3" as T5 #90EE90
participant "$ChaptersContainer\n/Chapter_4" as T6 #90EE90
participant "$ChaptersContainer\n/Chapter_5" as T7 #90EE90
participant "$ChaptersContainer\n/Chapter_6" as T8 #90EE90
participant "$ChaptersContainer\n/Chapter_7" as T9 #90EE90
participant "$ChaptersContainer\n/Chapter_8" as T10 #90EE90
participant "$Pin" as T20 #87CEFA
participant "$Menu" as T25 #90EE90
...
|*grow_horizontal* a|`2`
|*grow_vertical* a|`2`
|*script* a|link:/scripts/src/beginning/chapters/chapters.gd[res://src/beginning/chapters/chapters.gd]
|===
[.node-property.node-control]
.#$Banner# properties
[cols="1,3" options="header"]
...
|*anchors_preset* a|`-1`
|*anchor_left* a|`0.469`
|*anchor_right* a|`0.469`
|*offset_left* a|`-100.48`
|*offset_top* a|`-250.0`
|*offset_right* a|`99.52`
|*offset_bottom* a|`-50.0`
|===
[.node-property.node-control]
...
|*offset_left* a|`815.0`
|*offset_top* a|`-250.0`
|*offset_right* a|`817.0`
|*offset_bottom* a|`-82.0`
|*grow_horizontal* a|`2`
|===
[.node-property.node-control]
...
|Name |Value
|*layout_mode* a|`2`
|*focus_neighbor_left* a|`NodePath(".")`
|*focus_neighbor_top* a|`NodePath(".")`
|*focus_neighbor_right* a|`NodePath("../Chapter_1")`
|*focus_neighbor_bottom* a|`NodePath(".")`
|*focus_next* a|`NodePath("../Chapter_1")`
|*focus_previous* a|`NodePath(".")`
|*resource* a|`ExtResource("4_p776p")`
|===
[.node-property.node-control]
...
|Name |Value
|*layout_mode* a|`2`
|*focus_neighbor_left* a|`NodePath("../Chapter_0")`
|*focus_neighbor_top* a|`NodePath(".")`
|*focus_neighbor_right* a|`NodePath("../Chapter_2")`
|*focus_neighbor_bottom* a|`NodePath(".")`
|*focus_next* a|`NodePath("../Chapter_2")`
|*focus_previous* a|`NodePath("../Chapter_0")`
|*resource* a|`ExtResource("5_nuakg")`
|===
...
|===
|Name |Value
|*texture* a|[link=/assets/assets/images/ui/Chapters/Chapter_1.png]
[.asset-image]
...
|Name |Value
|*layout_mode* a|`2`
|*focus_neighbor_left* a|`NodePath("../Chapter_1")`
|*focus_neighbor_top* a|`NodePath(".")`
|*focus_neighbor_right* a|`NodePath("../Chapter_3")`
|*focus_neighbor_bottom* a|`NodePath(".")`
|*focus_next* a|`NodePath("../Chapter_3")`
|*focus_previous* a|`NodePath("../Chapter_1")`
|*resource* a|`ExtResource("7_vbe55")`
|===
[.node-property.node-plain]
...
|===
|Name |Value
|*texture* a|[link=/assets/assets/images/ui/Chapters/Chapter_2.png]
[.asset-image]
...
|Name |Value
|*layout_mode* a|`2`
|*focus_neighbor_left* a|`NodePath("../Chapter_2")`
|*focus_neighbor_top* a|`NodePath(".")`
|*focus_neighbor_right* a|`NodePath("../Chapter_4")`
|*focus_neighbor_bottom* a|`NodePath(".")`
|*focus_next* a|`NodePath("../Chapter_4")`
|*focus_previous* a|`NodePath("../Chapter_2")`
|*resource* a|`ExtResource("9_v7ooo")`
|===
[.node-property.node-plain]
...
|===
|Name |Value
|*texture* a|[link=/assets/assets/images/ui/Chapters/Chapter_3.png]
[.asset-image]
...
|Name |Value
|*layout_mode* a|`2`
|*focus_neighbor_left* a|`NodePath("../Chapter_3")`
|*focus_neighbor_top* a|`NodePath(".")`
|*focus_neighbor_right* a|`NodePath("../Chapter_5")`
|*focus_neighbor_bottom* a|`NodePath(".")`
|*focus_next* a|`NodePath("../Chapter_5")`
|*focus_previous* a|`NodePath("../Chapter_3")`
|*resource* a|`ExtResource("11_mdrma")`
|===
[.node-property.node-plain]
...
|===
|Name |Value
|*texture* a|[link=/assets/assets/images/ui/Chapters/Chapter_4.png]
[.asset-image]
...
|Name |Value
|*layout_mode* a|`2`
|*focus_neighbor_left* a|`NodePath("../Chapter_4")`
|*focus_neighbor_top* a|`NodePath(".")`
|*focus_neighbor_right* a|`NodePath("../Chapter_6")`
|*focus_neighbor_bottom* a|`NodePath(".")`
|*focus_next* a|`NodePath("../Chapter_6")`
|*focus_previous* a|`NodePath("../Chapter_4")`
|*resource* a|`ExtResource("13_y01i1")`
|===
[.node-property.node-plain]
...
|===
|Name |Value
|*texture* a|[link=/assets/assets/images/ui/Chapters/Chapter_5.png]
[.asset-image]
.res://assets/images/ui/Chapters/Chapter_5.png
image::/assets/raw/assets/images/ui/Chapters/Chapter_5.png[]
...
|Name |Value
|*layout_mode* a|`2`
|*focus_neighbor_left* a|`NodePath("../Chapter_5")`
|*focus_neighbor_top* a|`NodePath(".")`
|*focus_neighbor_right* a|`NodePath("../Chapter_7")`
|*focus_neighbor_bottom* a|`NodePath(".")`
|*focus_next* a|`NodePath("../Chapter_7")`
|*focus_previous* a|`NodePath("../Chapter_5")`
|*resource* a|`ExtResource("15_hivwg")`
|===
[.node-property.node-plain]
...
|===
|Name |Value
|*texture* a|[link=/assets/assets/images/ui/Chapters/Chapter_6.png]
[.asset-image]
...
|Name |Value
|*layout_mode* a|`2`
|*focus_neighbor_left* a|`NodePath("../Chapter_6")`
|*focus_neighbor_top* a|`NodePath(".")`
|*focus_neighbor_right* a|`NodePath("../Chapter_8")`
|*focus_neighbor_bottom* a|`NodePath(".")`
|*focus_next* a|`NodePath("../Chapter_8")`
|*focus_previous* a|`NodePath("../Chapter_6")`
|*resource* a|`ExtResource("17_7yar7")`
|===
[.node-property.node-plain]
...
|===
|Name |Value
|*texture* a|[link=/assets/assets/images/ui/Chapters/Chapter_7.png]
[.asset-image]
.res://assets/images/ui/Chapters/Chapter_7.png
image::/assets/raw/assets/images/ui/Chapters/Chapter_7.png[]
...
|Name |Value
|*layout_mode* a|`2`
|*focus_neighbor_left* a|`NodePath("../Chapter_7")`
|*focus_neighbor_top* a|`NodePath(".")`
|*focus_neighbor_right* a|`NodePath(".")`
|*focus_neighbor_bottom* a|`NodePath(".")`
|*focus_next* a|`NodePath(".")`
|*focus_previous* a|`NodePath("../Chapter_7")`
|*resource* a|`ExtResource("19_klsch")`
|===
[.node-property.node-plain]
...
|===
|Name |Value
|*texture* a|[link=/assets/assets/images/ui/Chapters/Chapter_8.png]
[.asset-image]
...
|*texture* a|[link=/assets/assets/guide/grid_1920x1080.png]
[.asset-image]
...
|Name |Value
|*visible* a|`false`
|*position* a|`Vector2(903, 554)`
|*scale* a|`Vector2(0.5, 0.5)`
|===
[.node-property.node-control]
.#$Menu# properties
[cols="1,3" options="header"]
...
|Name |Value
|*unique_name_in_owner* a|`true`
|*root_node* a|`NodePath("../ChaptersContainer")`
|*libraries* a|`{
