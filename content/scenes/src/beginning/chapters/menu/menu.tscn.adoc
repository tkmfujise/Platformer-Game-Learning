...
class N1 as "BannerBox" <<(C,#90EE90) Control>> {
}
class N2 as "ChapterNumber" <<(L,#90EE90) Label>> {
}
class N3 as "ChapterName" <<(L,#90EE90) Label>> {
}
class N4 as "Box" <<(N,#90EE90) NinePatchRect>> {
}
class N5 as "Banner" <<(S,#87CEFA) Sprite2D>> {
}
class N6 as "SideSelection" <<(N,#87CEFA) Node2D>> {
}
class N7 as "CenterBox" <<(C,#90EE90) Control>> {
}
class N8 as "BlueHeartIcon" <<(S,#87CEFA) Sprite2D>> {
}
class N9 as "StrawberryIcon" <<(S,#87CEFA) Sprite2D>> {
}
class N10 as "MultiplicationStrawberry" <<(S,#87CEFA) Sprite2D>> {
}
class N11 as "StrawberryCountContainer" <<(H,#90EE90) HBoxContainer>> {
}
class N12 as "ObtainedStrawberryCount" <<(L,#90EE90) Label>> {
}
class N13 as "Slash" <<(L,#90EE90) Label>> {
}
class N14 as "MaxStrawberryCount" <<(L,#90EE90) Label>> {
}
class N15 as "FailureIcon" <<(S,#87CEFA) Sprite2D>> {
}
class N16 as "MultiplicationStrawberry2" <<(S,#87CEFA) Sprite2D>> {
}
class N17 as "FailureCount" <<(L,#90EE90) Label>> {
}
class N18 as "BottomBox" <<(C,#90EE90) Control>> {
}
class N19 as "Label" <<(L,#90EE90) Label>> {
}
class N20 as "SideButtonContainer" <<(B,#90EE90) BoxContainer>> {
}
class N21 as "ClimbBookmark" <<(M,#90EE90) MarginContainer>> {
  ~ pressed
---
  * focused
---
...
class N22 as "CassetteBookmark" <<(M,#90EE90) MarginContainer>> {
  ~ pressed
---
  * focused
---
...
class N23 as "Sprite2D" <<(N,#A9A9A9) Node>> {
}
class N24 as "StageSelection" <<(N,#87CEFA) Node2D>> {
}
class N25 as "BottomBox" <<(C,#90EE90) Control>> {
}
class N26 as "StageLabel" <<(L,#90EE90) Label>> {
}
class N27 as "Photos" <<(N,#87CEFA) Node2D>> {
}
class N28 as "Template" <<(N,#87CEFA) Node2D>> {
}
class N29 as "Photo" <<(S,#87CEFA) Sprite2D>> {
  * flicked
  * image
---
  + set_image()
...
class N30 as "PhotoInstances" <<(N,#87CEFA) Node2D>> {
}
class N31 as "StageButtonContainer" <<(H,#90EE90) HBoxContainer>> {
}
class N32 as "Stage1Button" <<(M,#90EE90) MarginContainer>> {
  ~ pressed
---
  * focused
---
...
class N33 as "Bookmark" <<(N,#A9A9A9) Node>> {
}
class N34 as "Sprite2D" <<(N,#A9A9A9) Node>> {
}
class N35 as "Stage2Button" <<(M,#90EE90) MarginContainer>> {
  ~ pressed
---
  * focused
---
...
class N36 as "Bookmark" <<(N,#A9A9A9) Node>> {
}
class N37 as "Sprite2D" <<(N,#A9A9A9) Node>> {
}
class N38 as "Stage3Button" <<(M,#90EE90) MarginContainer>> {
  ~ pressed
---
  * focused
---
...
class N39 as "Bookmark" <<(N,#A9A9A9) Node>> {
}
class N40 as "Sprite2D" <<(N,#A9A9A9) Node>> {
}
class N41 as "Stage4Button" <<(M,#90EE90) MarginContainer>> {
  ~ pressed
---
  * focused
---
...
class N42 as "Bookmark" <<(N,#A9A9A9) Node>> {
}
class N43 as "Sprite2D" <<(N,#A9A9A9) Node>> {
}
class N44 as "Stage5Button" <<(M,#90EE90) MarginContainer>> {
  ~ pressed
---
  * focused
---
...
class N45 as "Bookmark" <<(N,#A9A9A9) Node>> {
}
class N46 as "Sprite2D" <<(N,#A9A9A9) Node>> {
}
class N47 as "ClosingCurtain" <<(C,#90EE90) Control>> {
  * pattern
  * next_scene
---
  + play()
...
class N48 as "AnimationPlayer" <<(A,#FFFF00) AnimationPlayer>> {
}
R --o N1
R --o N4
R --o N5
