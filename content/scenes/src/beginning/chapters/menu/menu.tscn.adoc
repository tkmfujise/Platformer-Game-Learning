...
|*chapter_resource* a|link:/resources/data/chapters/chapter_1.tres[res://data/chapters/chapter_1.tres]
|===
[.node-property.node-control]
...
|Name |Value
|*unique_name_in_owner* a|`true`
|*libraries/* a|`SubResource("AnimationLibrary_ebi0a")`
|===
