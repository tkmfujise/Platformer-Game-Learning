...
[plantuml]
....
class R as "Accounts" <<(M,#90EE90) MarginContainer>> {
  ~ ui_backed
  ~ get_started
---
  * grab_focus_first
...
class N1 as "AccountsContainer" <<(N,#87CEFA) Node2D>> {
}
class N2 as "Account1" <<(B,#90EE90) BoxContainer>> {
  ~ ui_backed
  ~ selected
  ~ unselected
  ~ get_started
...
class N3 as "Account2" <<(B,#90EE90) BoxContainer>> {
  ~ ui_backed
  ~ selected
  ~ unselected
  ~ get_started
...
class N4 as "Account3" <<(B,#90EE90) BoxContainer>> {
  ~ ui_backed
  ~ selected
  ~ unselected
  ~ get_started
...
class N5 as "AnimationPlayer" <<(A,#FFFF00) AnimationPlayer>> {
}
R --o N1
R --o N5
N1 --o N2
...
....
control "Root" as R
participant "$AccountsContainer\n/Account1" as T0 #90EE90
participant "$AccountsContainer\n/Account2" as T1 #90EE90
participant "$AccountsContainer\n/Account3" as T2 #90EE90
...
|*grow_horizontal* a|`2`
|*grow_vertical* a|`2`
|*theme_override_constants/margin_top* a|`90`
|*theme_override_constants/margin_bottom* a|`90`
|*script* a|link:/scripts/src/beginning/accounts/accounts.gd[res://src/beginning/accounts/accounts.gd]
|===
...
|*offset_top* a|`356.0`
|*offset_right* a|`1920.0`
|*offset_bottom* a|`656.0`
|*grow_horizontal* a|`1`
|*focus_neighbor_left* a|`NodePath(".")`
|*focus_neighbor_top* a|`NodePath("../Account1")`
|*focus_neighbor_right* a|`NodePath(".")`
|*focus_neighbor_bottom* a|`NodePath("../Account3")`
|*resource* a|`null`
|===
[.node-property.node-control]
...
|*offset_top* a|`656.0`
|*offset_right* a|`1920.0`
|*offset_bottom* a|`964.0`
|*grow_horizontal* a|`1`
|*focus_neighbor_left* a|`NodePath(".")`
|*focus_neighbor_top* a|`NodePath("../Account2")`
|*focus_neighbor_right* a|`NodePath(".")`
