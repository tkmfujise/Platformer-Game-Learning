...
class N3 as "SubViewport" <<(S,yellow) SubViewport>> {
}
...
=== Assets
[.asset-image]
[link=/assets/assets/images/beginning/MenuLogo.svg]
image::/assets/raw/assets/images/beginning/MenuLogo.svg[200, 100] 
...
```gdscript
func _on_accounts_get_started(_account: Account) -> void:
...
participant "$RootContainer\n/MenuContainer\n/OthersContainer" as T3 #87CEFA
participant "$RootContainer" as T6 #90EE90
...
participant "$Accounts" as T0 #90EE90
participant "$Chapters" as T1 #90EE90
participant "$RootContainer\n/MenuContainer\n/ClimbContainer" as T3 #87CEFA
participant "$RootContainer\n/MenuContainer\n/OthersContainer" as T4 #87CEFA
participant "$RootContainer" as T6 #90EE90
...
participant "$RootContainer" as T8 #90EE90
...
participant "$RootContainer\n/MenuContainer\n/ClimbContainer" as T8 #87CEFA
participant "$RootContainer\n/MenuContainer\n/OthersContainer" as T9 #87CEFA
...
|*script* a|link:/scripts/src/beginning/menu/menu.gd[res://src/beginning/menu/menu.gd]
|===
[.node-property.node-control]
...
|*anchors_preset* a|`9`
|*anchor_bottom* a|`1.0`
|*offset_right* a|`663.0`
|*offset_bottom* a|`30.0`
|*grow_vertical* a|`2`
|*theme_override_constants/margin_left* a|`180`
|*theme_override_constants/margin_top* a|`120`
...
|===
|Name |Value
|*custom_minimum_size* a|`Vector2(0, 240)`
|*offset_left* a|`170.0`
|*offset_right* a|`170.0`
|*offset_bottom* a|`240.0`
...
|*focus_neighbor_bottom* a|`NodePath("../../../OthersContainer/VBoxContainer/OptionsContainer/OptionsButton")`
|*theme_override_font_sizes/font_size* a|`100`
|*text* a|` CLIMB`
|*icon* a|`null`
|*focus_move_direction* a|`1`
|===
[.node-property.node-2d]
...
|===
|Name |Value
|*offset_right* a|`483.0`
|*offset_bottom* a|`281.0`
|===
[.node-property.node-control]
...
|*unique_name_in_owner* a|`true`
|*layout_mode* a|`2`
|*focus_neighbor_top* a|`NodePath("../../../../ClimbContainer/ButtonContainer/ClimbButton")`
|*focus_neighbor_bottom* a|`NodePath("../../CreditsContainer/CreditsButton")`
|*text* a|` Options`
|===
[.node-property.node-control]
...
|*unique_name_in_owner* a|`true`
|*layout_mode* a|`2`
|*focus_neighbor_top* a|`NodePath("../../OptionsContainer/OptionsButton")`
|*focus_neighbor_bottom* a|`NodePath("../../QuitContainer/QuitButton")`
|*text* a|` Credits`
|*icon* a|[link=/assets/assets/images/ui/Credits.svg]
[.asset-image]
...
|*unique_name_in_owner* a|`true`
|*layout_mode* a|`2`
|*focus_neighbor_top* a|`NodePath("../../CreditsContainer/CreditsButton")`
|*text* a|` Quit`
|*icon* a|[link=/assets/assets/images/ui/Quit.svg]
[.asset-image]
...
|*unique_name_in_owner* a|`true`
|*layout_mode* a|`1`
|*offset_left* a|`1920.0`
|*offset_right* a|`1920.0027`
|*offset_bottom* a|`-0.00048828125`
|===
[.node-property.node-control]
.#$Chapters# properties
[cols="1,3" options="header"]
...
|Name |Value
|*unique_name_in_owner* a|`true`
|*libraries/* a|`SubResource("AnimationLibrary_dft0i")`
|*autoplay* a|`&"opening"`
|===
...
func enter_chapter(idx: int) -> void:
	current_plate = Plate.CHAPTERS
	%AnimationPlayer.autoplay = ''
	%AnimationPlayer.play("chapters_selected")
	%Chapters.force_show(idx)
	%World.force_zoom_chapter(idx)
