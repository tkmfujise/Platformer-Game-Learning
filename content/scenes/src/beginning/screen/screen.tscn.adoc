...
[plantuml]
....
class R as "Screen" <<(C,#90EE90) Control>> {
  * MenuScenePath
  * current_animation
---
  + _ready()
...
class N1 as "Background" <<(C,#90EE90) ColorRect>> {
}
class N2 as "Author" <<(C,#90EE90) Control>> {
}
class N3 as "Container" <<(V,#90EE90) VBoxContainer>> {
}
class N4 as "NameContainer" <<(M,#90EE90) MarginContainer>> {
}
class N5 as "Name" <<(L,#90EE90) Label>> {
}
class N6 as "Presents" <<(L,#90EE90) Label>> {
}
class N7 as "Title" <<(C,#90EE90) Control>> {
}
class N8 as "TitleContainer" <<(C,#90EE90) CenterContainer>> {
}
class N9 as "TitleLogo" <<(S,#87CEFA) Sprite2D>> {
}
class N10 as "ButtonContainer" <<(M,#90EE90) MarginContainer>> {
}
class N11 as "JoyAButton" <<(S,#87CEFA) Sprite2D>> {
}
class N12 as "SubViewportContainer" <<(S,#90EE90) SubViewportContainer>> {
}
class N13 as "SubViewport" <<(S,#FFFF00) SubViewport>> {
}
class N14 as "Show" <<(N,#FF69B4) Node3D>> {
}
class N15 as "Blinder" <<(C,#90EE90) ColorRect>> {
}
class N16 as "AnimationPlayer" <<(A,#FFFF00) AnimationPlayer>> {
}
class N17 as "AnimationTree" <<(A,#FFFF00) AnimationTree>> {
}
R --o N1
R --o N2
R --o N7
...
|*MenuScenePath* a|`res://src/beginning/menu/menu.tscn`
|===
[.node-property.node-control]
...
|Name |Value
|*layout_mode* a|`2`
|*theme_override_fonts/font* a|`ExtResource("2_khub0")`
