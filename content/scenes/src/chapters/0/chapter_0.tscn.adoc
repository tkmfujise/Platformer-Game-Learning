---
title: src/chapters/0/chapter_0.tscn
---
:toc:
...
[plantuml]
....
class R as "Chapter0" <<(C,lightgreen) Control>> {
---
  + restart()
  + _on_stage_0_event()
  + _on_player_failed()
...
class N1 as "Transitionable" <<(N,darkgray) Node>> {
  * next_scene
  * callbacks
---
  + transit()
}
class N2 as "CanvasLayer" <<(C,yellow) CanvasLayer>> {
}
class N3 as "OpeningCurtain" <<(C,lightgreen) Control>> {
  ~ animation_finished
---
  * pattern
  * center
...
class N4 as "RestartCurtain" <<(C,lightgreen) Control>> {
  ~ animation_finished
---
  * pattern
  * center
...
class N5 as "Background" <<(C,lightgreen) ColorRect>> {
}
class N6 as "Forest" <<(N,lightskyblue) Node2D>> {
}
class N7 as "Frames" <<(N,lightskyblue) Node2D>> {
}
class N8 as "CameralFrame" <<(A,lightskyblue) Area2D>> {
  - HALF_SIZE
---
  + corner_of()
  + corner()
}
class N9 as "CameraFrame2" <<(A,lightskyblue) Area2D>> {
  - HALF_SIZE
---
  + corner_of()
  + corner()
}
class N10 as "CameraFrame3" <<(A,lightskyblue) Area2D>> {
  - HALF_SIZE
---
  + corner_of()
  + corner()
}
class N11 as "CameraFrame4" <<(A,lightskyblue) Area2D>> {
  - HALF_SIZE
---
  + corner_of()
  + corner()
}
class N12 as "CameraFrame5" <<(A,lightskyblue) Area2D>> {
  - HALF_SIZE
---
  + corner_of()
  + corner()
}
class N13 as "CameraFrame6" <<(A,lightskyblue) Area2D>> {
  - HALF_SIZE
---
  + corner_of()
  + corner()
}
class N14 as "StageGround0" <<(T,yellow) TileMapLayer>> {
}
class N15 as "Scenery" <<(N,lightskyblue) Node2D>> {
}
class N16 as "OldWoman" <<(N,lightskyblue) Node2D>> {
  ~ event
---
  * started
---
...
class N17 as "Voids" <<(N,lightskyblue) Node2D>> {
}
class N18 as "Area2D" <<(A,lightskyblue) Area2D>> {
}
class N19 as "CollisionShape2D" <<(C,lightskyblue) CollisionShape2D>> {
}
class N20 as "Area2D2" <<(A,lightskyblue) Area2D>> {
}
class N21 as "CollisionShape2D" <<(C,lightskyblue) CollisionShape2D>> {
}
class N22 as "Gimmicks" <<(N,lightskyblue) Node2D>> {
}
class N23 as "FallingIceBlock" <<(R,lightskyblue) RigidBody2D>> {
  * initial_position
---
  + _ready()
  + _process()
...
class N24 as "StoneBirdge" <<(N,lightskyblue) Node2D>> {
---
  + reset()
}
class N25 as "ClimbLecture" <<(N,lightskyblue) Node2D>> {
  * finished
---
  + idle()
  + show_hint()
...
class N26 as "DashLecture" <<(N,lightskyblue) Node2D>> {
  ~ finished
---
  * state
  * player
...
class N30 as "Area2D2" <<(A,lightskyblue) Area2D>> {
}
class N31 as "CollisionShape2D" <<(C,lightskyblue) CollisionShape2D>> {
}
class N32 as "AirWall" <<(N,lightskyblue) Node2D>> {
}
class N33 as "StaticBody2D" <<(S,lightskyblue) StaticBody2D>> {
}
class N34 as "CollisionShape2D" <<(C,lightskyblue) CollisionShape2D>> {
}
class N35 as "StaticBody2D2" <<(S,lightskyblue) StaticBody2D>> {
}
class N36 as "CollisionShape2D" <<(C,lightskyblue) CollisionShape2D>> {
}
class N37 as "Player" <<(C,lightskyblue) CharacterBody2D>> {
  ~ dashed
  ~ jumped
  ~ landed
  ~ failed
...
class N38 as "Weather" <<(N,lightskyblue) Node2D>> {
  - OFFSET
---
  + _process()
  + current_camera()
}
class N39 as "AnimationPlayer" <<(A,yellow) AnimationPlayer>> {
}
class N40 as "SoundEffect" <<(N,darkgray) Node>> {
  * player
---
  + _ready()
  + landed()
...
_(R::_on_stage_0_event, N16::event)
_(R::_on_dash_lecture_finished, N26::finished)
_(R::_on_player_failed, N37::failed)
....
...
=== Scene Tree
[.scene-tree]
* [.node-name.type-control]#Chapter0# [.node-type.type-control]#Control#
...
*** [.node-name.type-2d]#FallingIceBlock# [.node-type.type-2d]#link:/scenes/src/stages/0/gimmicks/falling_ice_block/falling_ice_block.tscn[res://src/stages/0/gimmicks/falling_ice_block/falling_ice_block.tscn]#
...
**** [.node-name.type-2d]#CollisionShape2D# [.node-type.type-2d]#CollisionShape2D#
*** [.node-name.type-2d]#StaticBody2D2# [.node-type.type-2d]#StaticBody2D#
**** [.node-name.type-2d]#CollisionShape2D# [.node-type.type-2d]#CollisionShape2D#
...
** [.node-name.type-plain]#SoundEffect# [.node-type.type-plain]#link:/scenes/src/audio/sound_effect/sound_effect.tscn[res://src/audio/sound_effect/sound_effect.tscn]#


=== Signal Connections
[.signal-connection]
.$Scenery/OldWoman:[#_event_#]=>$.
```gdscript
...
|*grow_horizontal* a|`2`
|*grow_vertical* a|`2`
|*script* a|link:/scripts/src/chapters/0/chapter_0.gd[res://src/chapters/0/chapter_0.gd]
...
|*callbacks* a|`Array("[SubResource("Resource_myk6b")]")`
|===
[.node-property.node-control]
...
|===
|Name |Value
|*position* a|`Vector2(-84, 329.5)`
|*shape* a|`SubResource("RectangleShape2D_1370o")`
|===
[.node-property.node-2d]
.#$AirWall/StaticBody2D2# properties
[cols="1,3" options="header"]
|===
|Name |Value
|*position* a|`Vector2(13636.882, -493.29504)`
|===
[.node-property.node-2d]
.#$AirWall/StaticBody2D2/CollisionShape2D# properties
[cols="1,3" options="header"]
|===
|Name |Value
|*position* a|`Vector2(39.118164, 18.295044)`
|*shape* a|`SubResource("RectangleShape2D_1370o")`
|===
[.node-property.node-2d]
.#$Player# properties
...
|Name |Value
|*unique_name_in_owner* a|`true`
|*libraries/* a|`SubResource("AnimationLibrary_arpf2")`
|*autoplay* a|`&"opening"`
|===
[.node-property.node-plain]
...
|===
|Name |Value
|*player* a|`NodePath("../Player")`
|===


=== link:/scripts/src/chapters/0/chapter_0.gd[chapter_0.gd]
