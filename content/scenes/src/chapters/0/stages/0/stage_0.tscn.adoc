...
class N12 as "StageGround0" <<(T,yellow) TileMapLayer>> {
}
class N13 as "Scenery" <<(N,lightskyblue) Node2D>> {
}
class N14 as "Stage0" <<(N,lightskyblue) Node2D>> {
  ~ event
---
  * started
---
...
class N15 as "Voids" <<(N,lightskyblue) Node2D>> {
}
class N16 as "Area2D" <<(A,lightskyblue) Area2D>> {
}
class N17 as "CollisionShape2D" <<(C,lightskyblue) CollisionShape2D>> {
}
class N18 as "Gimmicks" <<(N,lightskyblue) Node2D>> {
}
class N19 as "FallingIceBlock" <<(R,lightskyblue) RigidBody2D>> {
---
  + _ready()
  + _process()
  + fall()
...
class N20 as "Player" <<(C,lightskyblue) CharacterBody2D>> {
  ~ dashed
  ~ jumped
  ~ landed
  ~ failed
...
class N21 as "Weather" <<(N,lightskyblue) Node2D>> {
---
  + _process()
  + current_camera()
}
class N22 as "AnimationPlayer" <<(A,yellow) AnimationPlayer>> {
}
R --o N1
R --o N4
R --o N5
...
_(R::_on_stage_0_event, N14::event)
_(R::_on_player_failed, N20::failed)
....
...
|===
|Name |Value
|*tile_map_data* a|`PackedByteArray("")`
|===
[.node-property.node-2d]
...
|===
|Name |Value
|*position* a|`Vector2(5740, 1208.5)`
