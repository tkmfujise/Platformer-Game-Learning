...
class N15 as "OldWoman" <<(S,lightskyblue) Sprite2D>> {
}
class N16 as "Gimmicks" <<(N,lightskyblue) Node2D>> {
}
class N17 as "FallingIceBlock" <<(R,lightskyblue) RigidBody2D>> {
---
  + _ready()
  + _process()
  + fall()
...
class N18 as "Player" <<(C,lightskyblue) CharacterBody2D>> {
  ~ dashed
  ~ failed
---
  - SPEED
...
class N19 as "Weather" <<(N,lightskyblue) Node2D>> {
---
  + _process()
  + current_camera()
}
class N20 as "AnimationPlayer" <<(A,yellow) AnimationPlayer>> {
}
R --o N1
R --o N4
R --o N5
...
_(R::_on_player_failed, N18::failed)
....
...
|===
[.node-property.node-2d]
.#$Scenery/OldWoman# properties
[cols="1,3" options="header"]
|===
|Name |Value
|*position* a|`Vector2(6879, 240)`
|===
[.node-property.node-2d]
