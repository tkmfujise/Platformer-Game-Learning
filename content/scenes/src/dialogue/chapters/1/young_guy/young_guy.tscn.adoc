---
title: src/dialogue/chapters/1/young_guy/young_guy.tscn
---
:toc:
...
class N7 as "Tent" <<(S,lightskyblue) Sprite2D>> {
}
class N8 as "CollisionShape2D" <<(C,lightskyblue) CollisionShape2D>> {
}
class N9 as "Camera2D" <<(C,lightskyblue) Camera2D>> {
}
...
|*collision_layer* a|`0`
|*collision_mask* a|`16`
|*script* a|link:/scripts/src/dialogue/chapters/1/young_guy/young_guy.gd[res://src/dialogue/chapters/1/young_guy/young_guy.gd]
|===
...
|*visible* a|`false`
|*boot_file* a|link:/assets/src/dialogue/scenarios/chapter1/young_guy.ja.rb[res://src/dialogue/scenarios/chapter1/young_guy.ja.rb]
...
=== link:/scripts/src/dialogue/chapters/1/young_guy/young_guy.gd[young_guy.gd]
