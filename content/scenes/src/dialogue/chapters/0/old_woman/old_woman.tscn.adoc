---
title: src/dialogue/chapters/0/old_woman/old_woman.tscn
---
:toc:

== src / dialogue / chapters / 0 / old_woman / old_woman.tscn

=== Diagram
[plantuml]
....
class R as "OldWoman" <<(N,lightskyblue) Node2D>> {
  ~ event
---
  * started
---
...
=== Scene Tree
[.scene-tree]
* [.node-name.type-2d]#OldWoman# [.node-type.type-2d]#Node2D#
...
|===
|Name |Value
|*script* a|link:/scripts/src/dialogue/chapters/0/old_woman/old_woman.gd[res://src/dialogue/chapters/0/old_woman/old_woman.gd]
|===
...
|*visible* a|`false`
|*boot_file* a|link:/assets/src/dialogue/scenarios/chapter0/old_woman.ja.rb[res://src/dialogue/scenarios/chapter0/old_woman.ja.rb]
...
|Name |Value
|*unique_name_in_owner* a|`true`
|*libraries/* a|`SubResource("AnimationLibrary_7eiyn")`
|===


=== link:/scripts/src/dialogue/chapters/0/old_woman/old_woman.gd[old_woman.gd]
