...
class N1 as "FirstSteps" <<(A,yellow) AudioStreamPlayer>> {
}
R --o N1
...
|===
|Name |Value
|*script* a|link:/scripts/autoloads/bgm/bgm.gd[res://autoloads/bgm/bgm.gd]
|===
...
|===
|Name |Value
|*stream* a|`res://assets/audio/bgm/First_Steps_imitation_1bd.mp3`
|*parameters/looping* a|`true`
|===
