...
[plantuml]
....
class R as "KeyboardHandler" <<(N,darkgray) Node>> {
---
  + _input()
...
|===
|Name |Value
|*script* a|link:/scripts/autoloads/keyboard_handler/keyboard_handler.gd[res://autoloads/keyboard_handler/keyboard_handler.gd]
|===
