...
class N1 as "Chapters" <<(C,#90EE90) Control>> {
  ~ focused
  ~ selected
  ~ ui_backed
---
...
class N2 as "ReloadButton" <<(B,#90EE90) Button>> {
}
R --o N1
R --o N2
...
|*grow_horizontal* a|`2`
|*grow_vertical* a|`2`
|*theme* a|`ExtResource("1_4kat4")`
|*script* a|link:/scripts/debug/chapters/chapters.gd[res://debug/chapters/chapters.gd]
|*full_resource* a|`ExtResource("3_n6u80")`
|===
[.node-property.node-control]
.#$Chapters# properties
[cols="1,3" options="header"]
...
|*offset_left* a|`128.0`
|*offset_top* a|`796.0`
|*offset_right* a|`335.0`
|*offset_bottom* a|`887.0`
|*text* a|`Reload`
|===
